...
for frame = 1:num_frames
    ...
    %%
    %center = [pos(1) pos(2)];%获得矩形框的中心点纵，横坐标（高 宽）即第一帧图像的中心点
    %sigma = 100;
    ...
    %产生高斯形状的理想响应g
    %gaussC(R,C, sigma, center);  %调用高斯函数，得到高斯图
    %%
    if frame==1 
    ...
    [g_f, h_l] = run_training(model_xf, xcf, use_sz, params,yf, smallsz, frame, h_l);
